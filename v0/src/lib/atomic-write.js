...
// currentUid: INLINED from kernel safe-resolve.js:63-65 (the only symbol atomic-write
// used). Keeps the PACT v0 transfer surgical — a 2-line process.getuid() wrapper, zero
// deps — instead of dragging all 123 lines of safe-resolve (exec-policy helpers PACT
// does not use). Behavior byte-identical. (PACT v0 transfer; see TRANSFER-PROVENANCE.md)
function currentUid() {
