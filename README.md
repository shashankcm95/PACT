...
## Status: **v0 BUILT (2026-06-21)** — P0-minimal + P1 (the ATMS thesis core); 65 tests green incl. the D1–D7 definition-of-done

| Document | What |
|---|---|
| **[v0/](v0/)** | **the first buildable node — surgical transfer + the ATMS core; `v0/README.md` + the D1–D7 acceptance gate** ← the build |
| [plans/00-v0-build-plan.md](plans/00-v0-build-plan.md) | the v0 build plan (VERIFY board + post-build VALIDATE folded; status BUILT) |
